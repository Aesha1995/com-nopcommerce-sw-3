...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        compareElements(expectedMessage2, actualMessage2);
        ...
        expectedMessage = "2";
        actualMessage = getTextFromElement(By.xpath("//input[contains(@id,'itemquantity')]"));
        compareElements(expectedMessage, actualMessage);
        ...
        selectDropDownElements(By.xpath("//select[@id='CreditCardType']"), "Visa");
        ...
        compareElements(expectedMessage9, actualMessage9);
